...
select distinct  pdw3.current_date, pdw3.pcr_eod_nse, 
pdw2.current_date, pdw2.pcr_eod_nse, 
...
and pdw2.current_date >= date_add(pdw3.current_date,interval 1 day )
...
order by pdw2.current_date asc;


select pcr_eod_nse,pcr_data_whole.current_date from pcr_data_whole
where symbol = @SYMBOL order by pcr_data_whole.current_date asc;
